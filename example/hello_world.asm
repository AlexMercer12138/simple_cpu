...
start:
    ...
    MOV R3, #195310     ; R3 = 195310 (50000000的256分之1)
    ...
    ; 计数器计满1秒（约等于49999999）
    MOV R3, R3 << R4    ; R3 = 195310 << 8 = 49,999,360
...
main_loop:
    ...
    JMP R12, char_eq9           ; R1==9 -> 'd'(0x64)，使用R12作为链接寄存器
...
load_char:
    ...
    JMP R12, index_incr ; 否则索引递增，使用R12

index_clear:
    ; 清空窗口索引
    MOV R1, #0          ; R1 = 0
    JMP R12, store      ; 去写入内存，使用R12
...
delay:
    ...
    JMP R12, main_loop  ; 否则回到主循环，使用R12
