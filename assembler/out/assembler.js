...
exports.SimpleCPUAssembler = exports.InstructionType = void 0;
...
function parseNumericLiteral(token) {
    ...
    const radix = hexDigits ? 16 : binDigits ? 2 : 10;
...
function parseRegisterIndex(regStr) {
...
(function (InstructionType) {
    ...
    InstructionType[InstructionType["SUB"] = 2] = "SUB";
    InstructionType[InstructionType["AND"] = 3] = "AND";
    InstructionType[InstructionType["OR"] = 4] = "OR";
    InstructionType[InstructionType["XOR"] = 5] = "XOR";
    InstructionType[InstructionType["SLL"] = 6] = "SLL";
    InstructionType[InstructionType["SRL"] = 7] = "SRL";
    InstructionType[InstructionType["SRA"] = 8] = "SRA";
    InstructionType[InstructionType["MWR"] = 9] = "MWR";
    InstructionType[InstructionType["MRD"] = 10] = "MRD";
    InstructionType[InstructionType["JAL"] = 11] = "JAL";
    InstructionType[InstructionType["BEQ"] = 12] = "BEQ";
    InstructionType[InstructionType["BNE"] = 13] = "BNE";
    InstructionType[InstructionType["BLT"] = 14] = "BLT";
    InstructionType[InstructionType["BGE"] = 15] = "BGE";
...
class SimpleCPUAssembler {
    ...
    parseMov(operands, lineNum, lineContent) {
    ...
    parseJmp(operands, lineNum, lineContent) {
        if (operands.length !== 2) {
    ...
    parseBrc(operands, lineNum, lineContent) {
        if (operands.length < 2) {
    ...
    encodeInstruction(inst, currentAddr) {
        const OPCODE_I = 0x1;
        const OPCODE_R = 0x2;
...
exports.SimpleCPUAssembler = SimpleCPUAssembler;
